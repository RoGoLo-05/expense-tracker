  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg)] px-4">
      <div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full animate-fadeIn">
        <h1 className="text-3xl font-bold text-center mb-6 text-[var(--color-primary)]">Iniciar sesión</h1>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            onClick={handleLogin}
            className="bg-[var(--color-primary)] text-white font-semibold py-2 rounded-lg hover:bg-blue-700 transition"
          >
            Iniciar sesión
          </button>
        </div>
